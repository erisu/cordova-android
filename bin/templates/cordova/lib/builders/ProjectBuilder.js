    ...
    prepEnv (opts) {
        ...
        return check_reqs.check_gradle()
            .then(function (gradlePath) {
                ...
                const distributionUrl = process.env.CORDOVA_ANDROID_GRADLE_DISTRIBUTION_URL ||
                    (opts.gradleVersion ? `https://services.gradle.org/distributions/gradle-${opts.gradleVersion}-all.zip` : false) ||
