        ...
        return check_reqs.check_gradle()
            .then(function () {
                ...
                try {
                    ...
                    events.emit('warn', 'Error occured while removing old signing properties file.');
                }

                if (!opts.packageInfo) return;

                try {
                    const fd = fs.openSync(signingPropertiesPath, 'w');
                    ...
                    events.emit('warn', 'Error occured while writing signing properties file.');
                }
            });
    }
