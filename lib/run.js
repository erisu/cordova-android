...
const CordovaGradleConfigParser = require('./config/CordovaGradleConfigParser');
...
module.exports.run = async function (runOptions = {}) {
    ...
    const cordovaGradleConfigParser = new CordovaGradleConfigParser(this.locations.root);
